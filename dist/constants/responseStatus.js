...
function responeCustom(statusCode, message) {
    return Response(statusCode, message);
} // Dùng cho trường hợp cần trả về status code khác
function responseMessage200(message) {
    return Response(200, message);
} // Dùng cho việc ghi chú message
function responseData200(message, data, pagination) {
...
function responseCreateSuccess201(message = "Create successfully", data) {
...
const invalidFieldResquest = (errorMessage, data) => {
